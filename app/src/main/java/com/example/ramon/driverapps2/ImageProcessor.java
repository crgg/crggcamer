...
import com.example.ramon.driverapps2.helper.Quadrilateral;
import com.example.ramon.driverapps2.helper.ScannedDocument;
import com.example.ramon.driverapps2.helper.Utils;
...

{
    ...
    private final open_camera mMainActivity;
    ...
    public ImageProcessor(Looper looper, Handler uiHandler, open_camera mainActivity) {
        super(looper);
